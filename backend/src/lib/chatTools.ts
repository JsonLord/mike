...
- If fetch_statute returns "authoritative": false, the official service was unreachable and the wording came from a mirror. You may use it, but you MUST tell the user it is a mirror rather than the official text, give the official_url so they can confirm it, and mention how recently the mirror was updated. Never present mirrored wording as the official text.
